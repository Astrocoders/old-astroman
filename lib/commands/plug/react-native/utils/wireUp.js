...
export default function pluginWireUp({ source }){
  ...
  console.log('Wiring up new plugin'.white.bold)

  console.log('Attempt to wire up any reducers...'.white)
  if(fs.existsSync(pluginReducersPath)){
    console.log('Wiring up reducers...'.white)
  ...
  console.log('Attempt to wire up any redux logics...'.white)
  if(fs.existsSync(pluginLogicsPath)){
    console.log('Wiring up redux logics...'.white)
